...
impl State {
    ...
    fn game_over(&mut self, ctx: &mut BTerm) {
        ...
        ctx.print_color_centered(9, YELLOW, BLACK, "Press 1 to restart.");
    ...
    fn victory(&mut self, ctx: &mut BTerm) {
        ...
        ctx.print_color_centered(
            ...
            WHITE,
            BLACK,
            "You put the amulet of Yala on, and feel its power course through your veins!",
        );
        ctx.print_color_centered(
            5,
            WHITE,
            BLACK,
            "Your town will surely be saved, and you can return to your normal life.",
        );
...
impl GameState for State {
    fn tick(&mut self, ctx: &mut BTerm) {
        ...
        // To go back to the same console as the map and entities, use:
        ctx.set_active_console(0);
...
fn main() -> BError {
    let context = BTermBuilder::new()
        ...
        .with_simple_console_no_bg(
            DISPLAY_WIDTH * HUD_SCALE,
            DISPLAY_HEIGHT * HUD_SCALE,
            "terminal8x8.png",
        )
        .build()?;
